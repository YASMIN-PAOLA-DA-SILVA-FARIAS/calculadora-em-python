# importanto a biblioteca ttk

from ast import Str
from asyncio import events
from tkinter import *       # O * Significa que tudo que stiver dentro do tkinter sera importtado

from tkinter import ttk
# cores 
cor1 = "#020302"    # black / preto                    
cor2 = "#feffff"    # White / Branca
cor3 = "#030202"    # pretoo
cor4 = "#ECEFF1"    # Cinzenta
cor5 = "#3232a8"    # blue / azul
# Criando a interface grafica da calculadora:

janela = Tk()

janela.title("Calculadora")

janela.geometry("235x310")           # Definindo o tamanho da janela "Calculadora"
janela.config(bg=cor1)
                              
#   Criando o display da calculadora usando o frame
frame_tela = Frame(janela, width=235, height=50, bg=cor3)
frame_tela.grid(row=0,column=0)
#   Crian do o Segundo Frame
...
b_1.place(x=0, y=0) # Definindo o tamnho do botão limpar
...
b_2.place(x=118, y=0) # Definindo o tamnho do botão limpar
...
b_3.place(x=177, y=0) # Definindo o tamnho do botão limpar
...
b_4.place(x=0, y=52) # Definindo o tamnho do botão limpar
...
b_5.place(x=59, y=52) # Definindo o tamnho do botão limpar
...
b_6.place(x=118, y=52) # Definindo o tamnho do botão limpar
...
b_7.place(x=177, y=52) # Definindo o tamnho do botão limpar
...
b_8.place(x=0, y=104) # Definindo o tamnho do botão limpar
...
b_9.place(x=59, y=104) # Definindo o tamnho do botão limpar
...
b_10.place(x=118, y=104) # Definindo o tamnho do botão limpar
...
b_11.place(x=177, y=104) # Definindo o tamnho do botão limpar
...
b_12.place(x=0, y=156) # Definindo o tamnho do botão limpar
...
b_13.place(x=59, y=156) # Definindo o tamnho do botão limpar
...
b_14.place(x=118, y=156) # Definindo o tamnho do botão limpar
...
b_15.place(x=177, y=156) # Definindo o tamnho do botão limpar
...
b_16.place(x=0, y=208) # Definindo o tamnho do botão limpar
...
b_17.place(x=118, y=208) # Definindo o tamnho do botão limpar
...
b_18.place(x=177, y=208) # Definindo o tamnho do botão limpar
